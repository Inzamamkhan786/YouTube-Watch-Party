...
router.post('/verify-email', authRateLimiter, validateVerificationToken, (req, res, next) => authController.verifyEmail(req, res, next))
router.post('/verify-otp', authRateLimiter, validateVerificationToken, (req, res, next) => authController.verifyEmail(req, res, next))
